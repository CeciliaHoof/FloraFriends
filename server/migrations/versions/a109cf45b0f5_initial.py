...
Revision ID: a109cf45b0f5
Revises: 
Create Date: 2024-03-07 20:59:45.462560
...
def upgrade():
    ...
    sa.Column('purchased_plant_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['purchased_plant_id'], ['purchased_plants.id'], name=op.f('fk_plant_cares_purchased_plant_id_purchased_plants')),
